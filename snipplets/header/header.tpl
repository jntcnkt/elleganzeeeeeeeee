...
{% if not store.is_catalog and settings.ajax_cart and template != 'cart' %}           
    ...
    {% embed "snipplets/modal.tpl" with{modal_id: 'modal-cart', modal_class: 'cart', modal_position: 'right', modal_transition: 'slide', modal_width: 'docked-md', modal_form_action: store.cart_url, modal_form_class: 'js-ajax-cart-panel', modal_footer: true, fixed_footer: true, fixed_header: true, modal_mobile_full_screen: true, modal_form_hook: 'cart-form' } %}
        {% block modal_head %}
