...
<html xmlns="http://www.w3.org/1999/xhtml" xmlns:fb="http://www.facebook.com/2008/fbml" xmlns:og="http://opengraphprotocol.org/schema/">
    <head>
        ...
        {% if params.preview %}
            ...
            {{ '//fonts.googleapis.com/css?family=Muli:400,600,700|Lato:100,300,400,700,900|Open+Sans:400,300,700|Lora:400,700|Slabo+27px|Playfair+Display:900|Droid+Sans:400,700&display=swap' | css_tag }}
                    ...
                    <div class="col-md-8 text-center">
                        ...
                        {% embed "snipplets/forms/form.tpl" with{form_id: 'password-form', submit_text: 'Desbloquear' | translate } %}
                            {% block form_body %}
                                ...
                                {% embed "snipplets/forms/form-input.tpl" with{input_for: 'password', type_password: true, input_name: 'password', input_help: true, input_help_link: store.customer_reset_password_url, input_placeholder: 'Contraseña de acceso' | translate } %}
