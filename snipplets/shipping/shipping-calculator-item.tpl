            ...
            <div class="radio-button-label">
                ...
                <div class="radio-button-text row"> 
                    <div class="col-8 pr-0 font-small">
                        <div class="opacity-60 {% if option.payment_rules or option.time or option.suboptions is not empty %}mb-2{% endif %}">
                            {{option.short_name}} {% if option.method == 'branch' %}<span class="ml-1">{{ option.extra.extra }}</span>{% endif %}
                        </div>
                        {% if option.time %}
                            <div class="opacity-80 {% if option.suboptions is not empty or option.payment_rules %}mb-2{% endif %}">
