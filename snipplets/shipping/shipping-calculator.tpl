...
<div class="{% if product_detail %}product-shipping-calculator{% else %}w-100{% endif %} mb-2" data-store="shipping-calculator">
	...
	<div class="js-shipping-calculator-head shipping-calculator-head position-relative transition-soft mt-2 {% if cart_zipcode %}with-zip{% else %}with-form{% endif %} {% if has_free_shipping %}with-free-shipping{% endif %}">
		...
		<div class="js-shipping-calculator-with-zipcode {% if cart_zipcode %}js-cart-saved-zipcode transition-up-active{% endif %} w-100 transition-up position-absolute">
			...
			{% if has_free_shipping %}
				...
				<div class="free-shipping-title {% if product_detail %}text-md-left{% endif %}  transition-soft">
					...
					<div class="js-free-shipping-title-min-cost position-absolute transition-up w-100 h5 {% if not cart.free_shipping.cart_has_free_shipping and cart.free_shipping.min_price_free_shipping.min_price %}transition-up-active{% endif %}">
		...
		<div class="js-shipping-calculator-form {% if template != 'cart' %}mt-3{% endif %} transition-up position-absolute">
