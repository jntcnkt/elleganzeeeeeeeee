...
{% if settings.theme_variant == 'squared' %}
	<div class="{% if show_filters %}js-sticky-filters{% endif %} container-fluid">
		<div class="row align-items-center category-controls">
			...
			<div class="col-12 col-md-4">
				{% if products %}
					<div class="row {% if not show_filters %}justify-content-end{% endif %}">
						{% if show_filters %}
						...
						{% endif %}
						<div class="{% if show_filters %}col-6{% else %}col-12 col-md-7{% endif %} category-control-col">
			...
			<div class="col-12 col-md-3 px-0 px-sm-3">
				{% if products %}
					<div class="form-row align-items-center category-controls pt-3">
						...
						{% endif %}
						<div class="{% if show_filters %}col-8{% else %}col-12 col-md-8 offset-md-2{% endif %}">
							{% include 'snipplets/grid/sort-by.tpl' %}
						</div>
					</div>
				{% endif %}
