            ...
            <div class="row">
                <div class="col-md-8 offset-md-2">
                    ...
                    {% if settings.welcome_text %}
                        <h3 class="welcome-text font-secondary align-self-center mb-0 {% if  settings.theme_variant == 'squared' and settings.welcome_message %}col-12 col-md-6 text-left text-center-xs{% else %}text-center {% if  settings.theme_variant == 'rounded' %} col-12 mt-4{% endif %}{% endif %}">{{ settings.welcome_text }}</h3>
                    {% endif %}
                    {% if settings.welcome_message and settings.welcome_text %}
                    </div>
                    {% endif %}
